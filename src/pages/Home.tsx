 ...
 * Home Page
 * 
 * Dashboard principal com health check da API
 * Usa AppShell para layout (Navbar + Footer já inclusos)
 */
export const Home = () => {
    ...
    <div className="w-full">
      <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-semibold text-gray-700">React 19</p>
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          ...
          <p className="mt-2 font-mono text-xs">API Base: https://pet-manager-api.geia.vip</p>
        </div>
      </div>
    </div>
  );
