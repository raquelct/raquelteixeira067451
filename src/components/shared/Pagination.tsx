...
export const Pagination = ({
  ...
  return (
    <div className="flex items-center justify-between mt-8 px-4 py-3 bg-white border-t border-gray-200 sm:px-6 rounded-lg shadow-sm">
      {/* Mobile Navigation */}
        ...
        <div>
          <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
            ...
            <button
              ...
              disabled={currentPage === 0}
              className="relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              onClick={() => onPageChange(Math.max(0, currentPage - 1))}
              disabled={currentPage === 0}
              className="relative inline-flex items-center px-2 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
